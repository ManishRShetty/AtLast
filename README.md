...
🔮 Roadmap
[ ] Multiplayer Mode: WebSocket implementation for 1v1 duels.

[ ] Visual Riddles: Integrate GPT-4-Vision to analyze Street View images.

[ ] Persona Customization: Allow users to choose "Easy" (The Tourist) or "Hard" (The Historian) difficulty modes.
